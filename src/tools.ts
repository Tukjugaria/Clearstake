...
export const tools: Tool[] = [
  ...
  {
    path: '/vat',
    title: '부가가치세(VAT) — 일반 vs 간이',
    short: '부가가치세',
    desc: '매출·매입으로 일반과세·간이과세 납부세액을 동시 계산하고 유리한 방식을 비교합니다.',
    category: '세제',
    audience: 'founder',
  },
  {
    path: '/salary-take-home',
    title: '연봉 실수령 — 임직원 ↔ 회사 양면',
    short: '연봉 실수령',
    desc: '연봉으로 4대보험·소득세 뺀 월 실수령액과 회사 실부담을 한 화면에서 비교.',
    category: '운영',
    audience: 'both',
  },
  {
    ...
    title: '퇴직금·퇴직소득세 계산기',
    short: '퇴직금·퇴직소득세',
    desc: '평균임금과 근속연수로 퇴직금과 환산급여 방식 퇴직소득세, 세후 실수령을 계산.',
    category: '세제',
    audience: 'both',
  },
  {
    path: '/rnd-tax-credit',
    title: 'R&D 세액공제 (조특법 §10)',
    short: 'R&D 세액공제',
    desc: '당기·증가분 방식 비교 + 최저한세 적용 후 실제 절세액·납부세액을 산출.',
    category: '세제',
    audience: 'founder',
  },
  {
    path: '/salary-vs-dividend',
    title: '대표 급여 vs 배당 비교',
    short: '급여 vs 배당',
    desc: '같은 회사 이익을 급여로 가져갈 때와 배당으로 가져갈 때 본인 세후 실수령을 비교.',
    category: '세제',
    audience: 'founder',
  },
  {
    path: '/comp-package',
    title: '보상 패키지 시뮬레이터 (연봉+옵션+RSU+보너스)',
    short: '보상 패키지',
    desc: '4년 누적 회사 부담과 임직원 세후 실수령을 양면으로 비교하는 메타 도구.',
    category: '지분·딜',
    audience: 'both',
  },
];
